...
import {
    addDays,
    BookingQualityChart,
    BookingQualityWeekdayHistoryChart,
    BreakdownTable,
    comparisonDelta,
    CompletedVisitsByHourChart,
    CompletedVisitsRankingChart,
    firstQueryValue,
    formatDisplayDate,
    formatMoney,
    formatNumber,
    ...
    WeeklyAttendanceHealthTrendChart,
...
const STORAGE_KEY = "beness.dashboard.attendance";
...
export default function AttendancePage() {
    ...
    }, [canViewMoney, weeklyAttendanceTrendView]);
    ...
    const fetchDashboard = async () => {
        ...
        try {
            ...
            setError(err.response?.data?.detail || "Error loading attendance data.");
        } finally {
            setLoading(false);
        }
    };
    ...
    return (
        <MainPage>
            <Head>
                <title>Beness Analytics | Attendance</title>
            </Head>
            ...
            <Dialog open={expandedInsight === "weekly_attendance_health"} onClose={() => setExpandedInsight(null)} fullWidth maxWidth="lg">
                <DialogTitle>
            ...
            <Dialog open={expandedInsight === "weekly_attendance_weekday"} onClose={() => setExpandedInsight(null)} fullWidth maxWidth="lg">
                <DialogTitle>
                    <Stack direction="row" alignItems="center" justifyContent="space-between" gap={2}>
            ...
            <Dialog open={expandedInsight === "weekly_booking_quality_weekday"} onClose={() => setExpandedInsight(null)} fullWidth maxWidth="lg">
                <DialogTitle>
                    <Stack direction="row" alignItems="center" justifyContent="space-between" gap={2}>
