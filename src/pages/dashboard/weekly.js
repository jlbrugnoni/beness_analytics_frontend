...
const STORAGE_KEY = "beness.dashboard.weekly";
...
// ─── Derived active date range from period mode + filters ─────────────────────
...
export default function WeeklySummaryPage() {
    ...
    const periodLabel = t("common.week");
    ...
    useEffect(() => {
        ...
        if (hasWeeklyQuery(router.query)) {
    ...
    return (
        <MainPage>
            <Head>
                <title>Beness Analytics | Weekly Summary</title>
            </Head>
